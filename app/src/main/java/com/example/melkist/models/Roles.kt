...
data class Roles(
    ...
    val normalUser: Role = Role(id = 5, title = "کاربر عادی", value = "normaluser", R.drawable.normal_user),
    val dealer: Role = Role(id = 6, title = "معامله گر", value = "dealer", R.drawable.dealer)
)
